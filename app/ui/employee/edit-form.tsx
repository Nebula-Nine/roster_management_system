...
import { EmployeeForm } from '@/app/lib/definitions';
import {
  BriefcaseIcon,
  ClockIcon,
  UserPlusIcon,
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="Manager"
                  defaultChecked={employee.designation_type === 'Manager'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="Employee"
                  defaultChecked={employee.designation_type === 'Employee'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600"
                />
                <label
                  htmlFor="employee"
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                defaultValue={employee.contracted_hours}
              />
